...
INSERT INTO `pacientes` VALUES ('09769734136','Jõao Vitor de F Castro','2005-06-30','M','88888888','rua da abobrinha','99999999999','joaocastrocntt06@gmail.com'),('21279636059','Carlos Almeida Brandão','2000-07-12','M','72318105','RUA ALGODÃO MOLHADO N 57','44912345678','Carlos.lindo@gmail.com');
...
CREATE TABLE `tratamentos` (
  ...
  `idConsulta` int DEFAULT NULL,
  `nomeTratamento` varchar(15) DEFAULT NULL,
  `Descrição` varchar(200) DEFAULT NULL,
  ...
  KEY `idConsulta` (`idConsulta`),
  CONSTRAINT `tratamentos_ibfk_1` FOREIGN KEY (`idConsulta`) REFERENCES `consultas` (`idConsulta`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-08-23 17:35:10
